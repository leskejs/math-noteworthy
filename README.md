...
2. **Install Dependencies**
   - **Windows Users**: Open your command prompt and run the following command to install `windows-curses`:
     ...
     ```
   - For other systems, ensure that you install Typst and Poppler as per their documentation.
...
### 📑 Features
math-noteworthy provides several useful features for studying mathematics:

- **Interactive Content**: Engage with various mathematical concepts interactively.
- **PDF Export**: Create your own notes and export them to PDF for easy sharing and printing.
- **Multimedia Support**: Incorporate images and videos into your notes to enhance learning.
- **Search Functionality**: Quickly find topics or terms within the textbook.

### 📚 Authors
This project was crafted by Lee Sihoo and Lee Hojun from the Korea Science Academy of KAIST. Their expertise in mathematics and dedication to education shaped this application.
